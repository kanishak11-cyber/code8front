        ...
        <div className='wrapper'>
            <div className='privacy-container'>
                ...
                <div className='policy-para'>
                    ...
                    <h1 className='md:text-xl text-lg'>Interpretation and Definitions</h1>
                    <h1 className='subtitle'>Interpretation</h1>
                    <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                    <h1 className='subtitle'>Definitions</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to codeate.in.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Personal Data</strong>  is any data that relates to an identified or identifiable individual.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong>  refers to codeate.in, accessible from <a href='https://codeate.in'>https://codeate.in</a>.</p>
                        </li>
                        <li>
                    ...
                    <h3 className='subtitle'>Usage Data</h3>
                    ...
                    <h1 className='subtitle'>Tracking Technologies and Cookies</h1>
                    <p>
                        We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:
                    </p>
                    <h1 className='subtitle'>Third Party Privacy Policies </h1>
                    <ul>
                        <li>
                        ...
                        <li>
                            <p><strong>Flash Cookies.</strong>Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at
                                <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_">  link</a></p>
                        </li>
                        <li>
                            <p><strong>Web Beacon.</strong>  Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</p>
                        </li>
                    </ul>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Cookies Policy / Notice Acceptance Cookies.</strong>Type: Persistent Cookies <br />Administered by: Us<br />Purpose:  These Cookies identify if users have accepted the use of cookies on the Website.</p>
                        </li>
                        <li>
                            <p><strong>Functionality Cookies.</strong>Type: Persistent Cookies <br />Administered by: Us<br />Purpose:  These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                        </li>
                    </ul>
                    <p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy.</p>
                    <h1 className='subtitle'>Use of Your Personal Data</h1>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>To manage Your requests:</strong> To manage Your requests to Us.</p>
                        </li>
                        <li>
                    ...
                    <h1 className='subtitle'>Retention of Your Personal Data</h1>
                    <p>
